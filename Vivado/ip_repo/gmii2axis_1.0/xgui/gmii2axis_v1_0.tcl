...
proc init_gui { IPINST } {
  ...
  set C_M00_AXIS_START_COUNT [ipgui::add_param $IPINST -name "C_M00_AXIS_START_COUNT" -parent ${Page_0} -widget comboBox]
...
proc update_PARAM_VALUE.C_S00_AXIS_START_COUNT { PARAM_VALUE.C_S00_AXIS_START_COUNT } {
	# Procedure called to update C_S00_AXIS_START_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S00_AXIS_START_COUNT { PARAM_VALUE.C_S00_AXIS_START_COUNT } {
	# Procedure called to validate C_S00_AXIS_START_COUNT
	return true
}
...
proc update_MODELPARAM_VALUE.C_S00_AXIS_START_COUNT { MODELPARAM_VALUE.C_S00_AXIS_START_COUNT PARAM_VALUE.C_S00_AXIS_START_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S00_AXIS_START_COUNT}] ${MODELPARAM_VALUE.C_S00_AXIS_START_COUNT}
}
