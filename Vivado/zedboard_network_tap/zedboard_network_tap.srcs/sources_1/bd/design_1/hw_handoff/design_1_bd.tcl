...
CONFIG.Write_Acknowledge_Flag {false} \
  ...
  # Create instance: gmii_to_rgmii_axis_wrapper_0, and set properties
  set gmii_to_rgmii_axis_wrapper_0 [ create_bd_cell -type ip -vlnv user.org:user:gmii_to_rgmii_axis_wrapper:1.2 gmii_to_rgmii_axis_wrapper_0 ]
...
CONFIG.DOUT_WIDTH {1} \
  ...
  connect_bd_intf_net -intf_net gmii_to_rgmii_axis_wrapper_0_RGMII_0 [get_bd_intf_ports rgmii_port_0] [get_bd_intf_pins gmii_to_rgmii_axis_wrapper_0/RGMII_0]
  connect_bd_intf_net -intf_net gmii_to_rgmii_axis_wrapper_0_RGMII_1 [get_bd_intf_ports rgmii_port_1] [get_bd_intf_pins gmii_to_rgmii_axis_wrapper_0/RGMII_1]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_MDIO_ETHERNET_1 [get_bd_intf_pins gmii_to_rgmii_axis_wrapper_0/MDIO_GEM] [get_bd_intf_pins processing_system7_0/MDIO_ETHERNET_1]
  ...
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_M_AXIS_GMII0_RX_tdata [get_bd_pins gmii_to_rgmii_axis_wrapper_0/M_AXIS_GMII0_RX_tdata] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_M_AXIS_GMII0_RX_tvalid [get_bd_pins gmii_to_rgmii_axis_wrapper_0/M_AXIS_GMII0_RX_tvalid] [get_bd_pins or_gate_wr_en_fifo_0/Op2] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_M_AXIS_GMII1_RX_tdata [get_bd_pins gmii_to_rgmii_axis_wrapper_0/M_AXIS_GMII1_RX_tdata] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_M_AXIS_GMII1_RX_tvalid [get_bd_pins gmii_to_rgmii_axis_wrapper_0/M_AXIS_GMII1_RX_tvalid] [get_bd_pins or_gate_wr_en_fifo_1/Op2] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_gmii_0_rx_clk [get_bd_pins fifo_generator_0/wr_clk] [get_bd_pins gmii_to_rgmii_axis_wrapper_0/gmii_0_rx_clk]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_gmii_0_rx_er [get_bd_pins gmii_to_rgmii_axis_wrapper_0/gmii_0_rx_er] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_gmii_0_tx_clk [get_bd_pins fifo_generator_1/rd_clk] [get_bd_pins gmii_to_rgmii_axis_wrapper_0/gmii_0_tx_clk]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_gmii_1_rx_clk [get_bd_pins fifo_generator_1/wr_clk] [get_bd_pins gmii_to_rgmii_axis_wrapper_0/gmii_1_rx_clk]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_gmii_1_rx_er [get_bd_pins gmii_to_rgmii_axis_wrapper_0/gmii_1_rx_er] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_gmii_1_tx_clk [get_bd_pins fifo_generator_0/rd_clk] [get_bd_pins gmii_to_rgmii_axis_wrapper_0/gmii_1_tx_clk]
  connect_bd_net -net gmii_to_rgmii_axis_wrapper_0_link_status_AND [get_bd_pins gmii_to_rgmii_axis_wrapper_0/link_status_AND] [get_bd_pins link_status_not_gate/Op1]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins gmii_to_rgmii_axis_wrapper_0/clkin] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins gmii_to_rgmii_axis_wrapper_0/rx_reset] [get_bd_pins gmii_to_rgmii_axis_wrapper_0/tx_reset] [get_bd_pins util_vector_logic_0/Res]
  ...
  connect_bd_net -net xlslice_data_0_Dout [get_bd_pins gmii_to_rgmii_axis_wrapper_0/S_AXIS_GMII1_TX_tdata] [get_bd_pins xlslice_data_0/Dout]
  connect_bd_net -net xlslice_data_1_Dout [get_bd_pins gmii_to_rgmii_axis_wrapper_0/S_AXIS_GMII0_TX_tdata] [get_bd_pins xlslice_data_1/Dout]
  connect_bd_net -net xlslice_error_0_Dout [get_bd_pins gmii_to_rgmii_axis_wrapper_0/gmii_1_tx_er] [get_bd_pins xlslice_error_0/Dout]
  connect_bd_net -net xlslice_error_1_Dout [get_bd_pins gmii_to_rgmii_axis_wrapper_0/gmii_0_tx_er] [get_bd_pins xlslice_error_1/Dout]
  connect_bd_net -net xlslice_valid_0_Dout [get_bd_pins gmii_to_rgmii_axis_wrapper_0/S_AXIS_GMII1_TX_tvalid] [get_bd_pins or_gate_rd_en_fifo_0/Op2] [get_bd_pins xlslice_valid_0/Dout]
  connect_bd_net -net xlslice_valid_1_Dout [get_bd_pins gmii_to_rgmii_axis_wrapper_0/S_AXIS_GMII0_TX_tvalid] [get_bd_pins or_gate_rd_en_fifo_1/Op2] [get_bd_pins xlslice_valid_1/Dout]
...
preplace port rgmii_port_0 -pg 1 -y 620 -defaultsOSRD
preplace port rgmii_port_1 -pg 1 -y 640 -defaultsOSRD
preplace port reset_port_0 -pg 1 -y 1410 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 1360 -defaultsOSRD
preplace port reset_port_1 -pg 1 -y 1500 -defaultsOSRD
preplace portBus ref_clk_fsel -pg 1 -y 1120 -defaultsOSRD
preplace portBus ref_clk_oe -pg 1 -y 1210 -defaultsOSRD
preplace inst xlslice_data_0 -pg 1 -lvl 1 -y 710 -defaultsOSRD
preplace inst not_gate_full_fifo_0 -pg 1 -lvl 2 -y 50 -defaultsOSRD
preplace inst xlslice_data_1 -pg 1 -lvl 1 -y 530 -defaultsOSRD
preplace inst not_gate_full_fifo_1 -pg 1 -lvl 2 -y 1000 -defaultsOSRD
preplace inst or_gate_rd_en_fifo_0 -pg 1 -lvl 3 -y 1240 -defaultsOSRD
preplace inst or_gate_wr_en_fifo_0 -pg 1 -lvl 3 -y 60 -defaultsOSRD
preplace inst or_gate_rd_en_fifo_1 -pg 1 -lvl 3 -y 1130 -defaultsOSRD
preplace inst or_gate_wr_en_fifo_1 -pg 1 -lvl 3 -y 560 -defaultsOSRD
preplace inst ref_clk_fsel -pg 1 -lvl 4 -y 1120 -defaultsOSRD
preplace inst ref_clk_oe -pg 1 -lvl 4 -y 1210 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 3 -y 190 -defaultsOSRD
preplace inst link_status_not_gate -pg 1 -lvl 3 -y 440 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 1 -y 980 -defaultsOSRD
preplace inst gmii_to_rgmii_axis_wrapper_0 -pg 1 -lvl 2 -y 760 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 3 -y 320 -defaultsOSRD
preplace inst util_reduced_logic_0 -pg 1 -lvl 4 -y 1410 -defaultsOSRD
preplace inst xlslice_valid_0 -pg 1 -lvl 1 -y 620 -defaultsOSRD
preplace inst util_reduced_logic_1 -pg 1 -lvl 4 -y 1500 -defaultsOSRD
preplace inst not_gate_empty_fifo_0 -pg 1 -lvl 2 -y 1220 -defaultsOSRD
preplace inst xlslice_valid_1 -pg 1 -lvl 1 -y 440 -defaultsOSRD
preplace inst xlslice_error_0 -pg 1 -lvl 1 -y 890 -defaultsOSRD
preplace inst not_gate_empty_fifo_1 -pg 1 -lvl 2 -y 1120 -defaultsOSRD
preplace inst xlslice_error_1 -pg 1 -lvl 1 -y 800 -defaultsOSRD
preplace inst fifo_generator_0 -pg 1 -lvl 4 -y 420 -defaultsOSRD
preplace inst fifo_generator_1 -pg 1 -lvl 4 -y 930 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 1310 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 4 NJ 1340 NJ 1340 NJ 1340 NJ
preplace netloc gmii_to_rgmii_axis_wrapper_0_M_AXIS_GMII0_RX_tvalid 1 2 1 1060
preplace netloc or_gate_rd_en_fifo_0_Res 1 3 1 1480
preplace netloc fifo_generator_1_prog_full 1 1 4 580 950 NJ 800 NJ 800 1830
preplace netloc ref_clk_fsel_dout 1 4 1 NJ
preplace netloc util_reduced_logic_1_Res 1 4 1 NJ
preplace netloc gmii_to_rgmii_axis_wrapper_0_M_AXIS_GMII1_RX_tdata 1 2 1 1080
preplace netloc gmii_to_rgmii_axis_wrapper_0_gmii_1_tx_clk 1 2 2 1140 500 NJ
preplace netloc gmii_to_rgmii_axis_wrapper_0_gmii_1_rx_clk 1 2 2 NJ 840 1420
preplace netloc or_gate_wr_en_fifo_0_Res 1 3 1 1510
preplace netloc gmii_to_rgmii_axis_wrapper_0_M_AXIS_GMII1_RX_tvalid 1 2 1 1110
preplace netloc gmii_to_rgmii_axis_wrapper_0_link_status_AND 1 2 1 1150
preplace netloc or_gate_wr_en_fifo_1_Res 1 3 1 1440
preplace netloc fifo_generator_0_prog_empty 1 1 4 570 490 NJ 490 NJ 550 1830
preplace netloc gmii_to_rgmii_axis_wrapper_0_gmii_0_tx_clk 1 2 2 NJ 820 1430
preplace netloc util_vector_logic_0_Res 1 1 1 560
preplace netloc xlconcat_1_dout 1 3 1 1490
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 4 40 1040 510 1410 NJ 1410 1470
preplace netloc gmii_to_rgmii_axis_wrapper_0_RGMII_0 1 2 3 NJ 620 NJ 620 NJ
preplace netloc gmii_to_rgmii_axis_wrapper_0_gmii_1_rx_er 1 2 1 1120
preplace netloc xlslice_valid_1_Dout 1 1 2 550 560 NJ
preplace netloc ref_clk_oe_dout 1 4 1 NJ
preplace netloc gmii_to_rgmii_axis_wrapper_0_RGMII_1 1 2 3 NJ 640 NJ 640 NJ
preplace netloc gmii_to_rgmii_axis_wrapper_0_gmii_0_rx_clk 1 2 2 N 780 NJ
preplace netloc gmii_to_rgmii_axis_wrapper_0_gmii_0_rx_er 1 2 1 1090
preplace netloc fifo_generator_1_prog_empty 1 1 4 580 1060 NJ 1060 NJ 1060 1830
preplace netloc not_gate_empty_fifo_0_Res 1 2 1 NJ
preplace netloc not_gate_full_fifo_0_Res 1 2 1 NJ
preplace netloc xlslice_data_0_Dout 1 1 1 NJ
preplace netloc xlslice_data_1_Dout 1 1 1 NJ
preplace netloc not_gate_empty_fifo_1_Res 1 2 1 NJ
preplace netloc xlconcat_0_dout 1 3 1 1500
preplace netloc processing_system7_0_MDIO_ETHERNET_1 1 1 1 530
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 1360 NJ 1360 NJ 1360 NJ
preplace netloc util_reduced_logic_0_Res 1 4 1 NJ
preplace netloc gmii_to_rgmii_axis_wrapper_0_M_AXIS_GMII0_RX_tdata 1 2 1 1070
preplace netloc xlslice_error_0_Dout 1 1 1 NJ
preplace netloc not_gate_full_fifo_1_Res 1 2 1 NJ
preplace netloc fifo_generator_1_dout 1 0 4 30 1030 NJ 1050 NJ 930 NJ
preplace netloc fifo_generator_0_dout 1 0 4 20 390 NJ 390 NJ 390 NJ
preplace netloc fifo_generator_0_prog_full 1 1 4 550 120 NJ 120 NJ 120 1830
preplace netloc processing_system7_0_FCLK_CLK0 1 0 2 40 1050 500
preplace netloc xlslice_error_1_Dout 1 1 1 NJ
preplace netloc link_status_not_gate_Res 1 3 1 1450
preplace netloc processing_system7_0_FCLK_CLK1 1 1 1 550
preplace netloc or_gate_rd_en_fifo_1_Res 1 3 1 1510
preplace netloc xlslice_valid_0_Dout 1 1 2 530 570 NJ
levelinfo -pg 1 0 270 830 1300 1670 1850 -top 0 -bot 1570
",
}
